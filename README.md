...
- In review, the wireframes stayed generally consistent with the finished design (in respect of the home page, phrases page, login page and register page) but I added additional pages to my project in respect of profile, add phrase, edit phrase and 404/500 errors as the project progressed and I understood the requirement for these pages.
